...
@interface SEFilterControl ()<UIGestureRecognizerDelegate>
{
    CGPoint diffPoint;
    NSArray *titlesArr;
    float oneSlotSize;
...
-(id) initWithFrame:(CGRect) frame Titles:(NSArray *) titles{
    if (self = [super initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, frame.size.width, 70)]) {
        ...
        [_handler setFrame:CGRectMake(LEFT_OFFSET, 8, 80 * kScale, 44 * kScale)];
        ...
        image1 = [UIImage imageNamed:@"10分钟"];
        image2 = [UIImage imageNamed:@"30分钟"];
        image3 = [UIImage imageNamed:@"50分钟"];
        image4 = [UIImage imageNamed:@"2小时"];
